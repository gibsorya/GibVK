...
namespace gibvk::vulkan::renderpasses {
	RenderPass::RenderPass()
	{
		...
		auto depthAttachment = vk::AttachmentDescription({}, drawing::depthresources::findDepthFormat(), vk::SampleCountFlagBits::e1, vk::AttachmentLoadOp::eClear,
		...
		auto subpass = vk::SubpassDescription({}, vk::PipelineBindPoint::eGraphics, 0, nullptr, 1, &colorAttachmentRef, nullptr, &depthAttachmentRef, 0, 0);

...
private:
    ...
    void createInstance() {
        ...
        //Struct with info on application
        ...
        //Tells Vulkan drive which global extensions and validation layers we want to use
    ...
    void createLogicalDevice() {
        ...
        for (uint32_t queueFamily : uniqueQueueFamilies) {
            VkDeviceQueueCreateInfo queueCreateInfo{}; //Describes number of queues we want for a single queue family
    ...
    void createSwapchain() {
        ...
        createInfo.compositeAlpha = VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR; //specifies if alpha channel should be used for blending with other windows in window system
    ...
    void createGraphicsPipeline() {
        ...
        //Describes region of the framebuffer that the output will be rendered to
        VkViewport viewport{};
        viewport.x = 0.0f;
        viewport.y = 0.0f;
        ...
        rasterizer.polygonMode = VK_POLYGON_MODE_FILL; //Determines how fragments are generated for geometry. VK_POLYGON_MODE_FILL fills the area of the polygon with fragments
        ...
        if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &mainGraphicsPipeline) != VK_SUCCESS) {
    ...
    static std::vector<char> readFile(const std::string& fileName) {
        ...
        file.close();
        std::cout << "FILE NAME: " << fileName.c_str() << "  BUFFER SIZE: " << buffer.size() << std::endl;
        return buffer;
    }
    ...
    void createCommandBuffers() {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++) {
            ...
            vkCmdBindPipeline(commandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, mainGraphicsPipeline);
